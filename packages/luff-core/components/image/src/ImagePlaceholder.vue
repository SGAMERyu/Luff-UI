<template>
  <svg class="lu-image-placeholder-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
<style lang="ts">
css({
  '.lu-image-placeholder-icon': {
    width: '{size.image.placeholderIcon}',
    height: '{size.image.placeholderIcon}',
  }
})
</style>